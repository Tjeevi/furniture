...
import dc11 from "./Assets/dc1.jfif" 
import dc12 from "./Assets/dc2.jfif" 
import dc13 from "./Assets/dc3.jfif" 
import dc14 from "./Assets/dc4.jfif" 
import dc15 from "./Assets/dc5.jfif" 
...
import sr11 from "./Assets/sr1.jfif"
import sr12 from "./Assets/sr2.jfif"
import sr13 from "./Assets/sr3.jfif"

import st11 from "./Assets/st1.jfif"
import st12 from "./Assets/st2.jfif"
import st13 from "./Assets/st3.jfif"
import st14 from "./Assets/st4.jfif"
import st15 from "./Assets/st5.jfif"
import st16 from "./Assets/st6.jfif"
import st17 from "./Assets/st7.jfif"
...
import bed1 from "./Assets/bedicon.png"
import dining1 from "./Assets/dining.jfif"
import sofa1 from "./Assets/sofa.jpg"
import cupboard1 from "./Assets/cupboard.png"
import poojaa1 from "./Assets/poojaa.jpg"
...
// const catee=menu.map(furniture=>furniture.fname)
// console.log(catee);

// const uniqcatee=[...new Set(catee)]
// console.log(uniqcatee);
...
// const filterdatas=menu.filter(
//      furniture=>furniture.fname===depp)
...
return(
     <div className="product">
         <h1 className="head">Product</h1><br></br>
          <div className="align-cont">
           {uniqcate.map(dep=>
                   <span onClick={()=>table(dep)}className="hd"><img src={dep} width={100} height="100px" /></span>)} </div><br></br>
    <div className="bgg">
    <div className="center"> 
       {menulist.map(furniture=>
         <div className="itms" key={furniture.id}><br></br>
